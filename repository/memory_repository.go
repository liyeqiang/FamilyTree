...
// 所有其他方法都返回空实现
func (r *memoryRepository) CreateEvent(ctx context.Context, event *models.Event) (*models.Event, error) { return event, nil }
func (r *memoryRepository) GetEventByID(ctx context.Context, id int) (*models.Event, error) { return nil, fmt.Errorf("未实现") }
func (r *memoryRepository) UpdateEvent(ctx context.Context, id int, event *models.Event) (*models.Event, error) { return event, nil }
func (r *memoryRepository) DeleteEvent(ctx context.Context, id int) error { return nil }
func (r *memoryRepository) GetEventsByIndividualID(ctx context.Context, individualID int) ([]models.Event, error) { return []models.Event{}, nil }
func (r *memoryRepository) GetEventsByType(ctx context.Context, eventType string, limit, offset int) ([]models.Event, int, error) { return []models.Event{}, 0, nil }
func (r *memoryRepository) GetEventsByDateRange(ctx context.Context, startDate, endDate *string, limit, offset int) ([]models.Event, int, error) { return []models.Event{}, 0, nil }
func (r *memoryRepository) GetEventsByPlaceID(ctx context.Context, placeID int, limit, offset int) ([]models.Event, int, error) { return []models.Event{}, 0, nil }

func (r *memoryRepository) CreatePlace(ctx context.Context, place *models.Place) (*models.Place, error) { return place, nil }
...
func (r *memoryRepository) UpdatePlace(ctx context.Context, id int, place *models.Place) (*models.Place, error) { return place, nil }
func (r *memoryRepository) DeletePlace(ctx context.Context, id int) error { return nil }
func (r *memoryRepository) SearchPlaces(ctx context.Context, query string, limit, offset int) ([]models.Place, int, error) { return r.places, len(r.places), nil }
func (r *memoryRepository) GetPlacesByCoordinates(ctx context.Context, minLat, maxLat, minLon, maxLon float64, limit, offset int) ([]models.Place, int, error) { return []models.Place{}, 0, nil }

func (r *memoryRepository) CreateSource(ctx context.Context, source *models.Source) (*models.Source, error) { return source, nil }
func (r *memoryRepository) GetSourceByID(ctx context.Context, id int) (*models.Source, error) { return nil, fmt.Errorf("未实现") }
func (r *memoryRepository) UpdateSource(ctx context.Context, id int, source *models.Source) (*models.Source, error) { return source, nil }
func (r *memoryRepository) DeleteSource(ctx context.Context, id int) error { return nil }
func (r *memoryRepository) SearchSources(ctx context.Context, query string, limit, offset int) ([]models.Source, int, error) { return []models.Source{}, 0, nil }
func (r *memoryRepository) GetSourcesByAuthor(ctx context.Context, author string, limit, offset int) ([]models.Source, int, error) { return []models.Source{}, 0, nil }
func (r *memoryRepository) GetSourcesByYear(ctx context.Context, year int, limit, offset int) ([]models.Source, int, error) { return []models.Source{}, 0, nil }

func (r *memoryRepository) CreateCitation(ctx context.Context, citation *models.Citation) (*models.Citation, error) { return citation, nil }
func (r *memoryRepository) GetCitationByID(ctx context.Context, id int) (*models.Citation, error) { return nil, fmt.Errorf("未实现") }
func (r *memoryRepository) UpdateCitation(ctx context.Context, id int, citation *models.Citation) (*models.Citation, error) { return citation, nil }
func (r *memoryRepository) DeleteCitation(ctx context.Context, id int) error { return nil }
func (r *memoryRepository) GetCitationsByEntity(ctx context.Context, entityType models.EntityType, entityID int) ([]models.Citation, error) { return []models.Citation{}, nil }
func (r *memoryRepository) GetCitationsBySourceID(ctx context.Context, sourceID int, limit, offset int) ([]models.Citation, int, error) { return []models.Citation{}, 0, nil }

func (r *memoryRepository) CreateNote(ctx context.Context, note *models.Note) (*models.Note, error) { return note, nil }
func (r *memoryRepository) GetNoteByID(ctx context.Context, id int) (*models.Note, error) { return nil, fmt.Errorf("未实现") }
func (r *memoryRepository) UpdateNote(ctx context.Context, id int, note *models.Note) (*models.Note, error) { return note, nil }
func (r *memoryRepository) DeleteNote(ctx context.Context, id int) error { return nil }
func (r *memoryRepository) GetNotesByEntity(ctx context.Context, entityType models.EntityType, entityID int) ([]models.Note, error) { return []models.Note{}, nil }
func (r *memoryRepository) SearchNotes(ctx context.Context, query string, limit, offset int) ([]models.Note, int, error) { return []models.Note{}, 0, nil }
